...
public class TancSoStudentite {
    ...
    static Semaphore mUcesnici;
    static Semaphore zUcesnici;
    static Semaphore showVlez;
    ...
    public void init() {
        ...
        mUcesnici = new Semaphore(10);
        zUcesnici = new Semaphore(10);
        showVlez = new Semaphore(3);
        partnerka = new Semaphore(0);
        z = new Semaphore(1);
        m = new Semaphore(1);
